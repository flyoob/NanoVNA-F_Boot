...
![1](https://www.deepelec.com/files/vna-f/img/STM32.jpg)

2. 随后，NanoVNA-F在电脑端显示为一个 U 盘，将新的 update.bin 拷入。  
   Then at PC side, device act as a Udisk. Copy you new update.bin into it.  
![2](https://www.deepelec.com/files/vna-f/img/PC_Udisk.png)
![3](https://www.deepelec.com/files/vna-f/img/Copy_bin.jpg)
![4](https://www.deepelec.com/files/vna-f/img/Copy_bin_1.jpg)

3. 设备重新上电，自动运行 APP。  
   Re-power the device and run the app automatically.  
![5](https://www.deepelec.com/files/vna-f/img/STM32_RUNAPP.jpg)
...
![6](https://www.deepelec.com/files/vna-f/img/MDK-ARM.jpg)
